    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          transition: "transform 0.5s ease-out", // Slower response
        }}
      >
      ...
      <div
        ...
        style={{
          ...
          transition: "transform 0.6s ease-out", // Slower response
        }}
      >
      ...
      <div
        ...
        style={{
          ...
          transition: "transform 0.4s ease-out", // Slower response
        }}
      >
      ...
      <div
        ...
        style={{
          ...
          transform: `translate(${mousePos.x * 0.02}px, ${
            mousePos.y * -0.01
          }px) rotate(${mousePos.x * 0.05}deg)`, // Reduced movement
          transition: "transform 0.8s ease-out", // Slower response
        }}
      >
      ...
      <div
        ...
        style={{
          ...
          transform: `translate(${mousePos.x * -0.025}px, ${
            mousePos.y * 0.015
          }px) rotate(${mousePos.x * -0.08}deg)`, // Reduced movement
          transition: "transform 0.6s ease-out", // Slower response
        }}
      >
